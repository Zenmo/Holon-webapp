...
export default function KPIRadioButtons({ updateValue, loading, dashboardId, ...props }: RadioButtons) {
  return (
    <div {...props} style={{
      display: "flex",
      ...
      <label htmlFor={`${dashboardId}-lokaal`} className="flex flex-row mb-2" style={{
        alignItems: "center",
      }}>
        <input
          defaultChecked={true}
        ...
        <InteractiveInputPopover
          ...
          linkWikiPage={"wiki/gebruikershandleiding/5-simulatiemodel/algemene-introductie/"}
          target="_blank"/>
      </label>

      <label htmlFor={`${dashboardId}-regionaal`} className="flex flex-row mb-2" style={{
        alignItems: "center",
      }}>
        <input
          type="radio"
        ...
        <InteractiveInputPopover
          ...
          // This link is brittle since it is a reference to content in the CMS.
          linkWikiPage={"wiki/gebruikershandleiding/3-key-perfomance-indicatoren/kpis-op-regionaal-en-nationaal-niveau/"}
          target="_blank"/>
      </label>

      <label htmlFor={`${dashboardId}-nationaal`} className="flex flex-row mb-2" style={{
        alignItems: "center",
      }}>
        <input
          type="radio"
