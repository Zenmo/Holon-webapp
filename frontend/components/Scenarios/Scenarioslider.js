    ...
    <div className="mb-2 flex flex-row items-center justify-between gap-2">
      ...
      <div className="flex flex-row items-center justify-between gap-2">
        ...
        <input
          ...
          className={`w-16 ${
            locked
              ? "cursor-not-allowed border-gray-500 text-slate-500"
              : "border-holon-blue-900 text-holon-blue-900 "
          } rounded-sm border-2  bg-white p-1 text-right shadow-holon-blue placeholder:font-light placeholder:italic placeholder:text-holon-slated-blue-300 disabled:shadow-gray-500`}
          min="0"
          max="100"
        />
        <span>%</span>
