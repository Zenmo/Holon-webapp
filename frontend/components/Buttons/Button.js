...
export default function Button({ children, variant = "default", ...rest }) {
  ...
  return (
    <button
      className={`${colorClasses} relative inline-flex items-center rounded-md py-2 px-3 font-medium leading-5 shadow-sm outline-none ring-1 transition focus-visible:ring-2 active:shadow-inner`}
      {...rest}
    >
