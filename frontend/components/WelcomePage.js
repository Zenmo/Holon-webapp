    ...
    <div className="flex-col items-start">
      ...
      <div className="mx-16 mt-4 mb-24 flex flex-wrap justify-center">
        ...
        <div className="w-1/2 p-8 pt-0">
          <HolonButton tag="a" variant="gold" href="#introVideo" className="text-base">
            Vertel me meer!
          </HolonButton>
        </div>
        <div className="w-1/2 p-8 pt-0">
