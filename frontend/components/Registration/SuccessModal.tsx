...
export default function SuccessModal({ onClose }) {
  ...
  return (
    <div>
      <div className="z-10 overflow-y-auto bg-gray-100 w-3/4 md:w-2/3 lg:w-1/3 h-[300px] absolute top-[15%] left-1/3 border-2 border-gray-700 border-solid rounded">
        ...
        <div className="flex flex-col items-center m-8">
          ...
          <p className="text-center">
            Bedankt voor je registratie! Deze is registratie succesvol verwerkt. Om je registratie
            definitief te maken ontvang je een e-mail in je inbox. Via deze e-mail kan je inloggen
            op{" "}
            <a
              href="www.holontool.nl"
              target="_blank"
