                        ...
                        wagtail.blocks.StreamBlock(
                            [
                                (
                                    "step_anchor",
                                    wagtail.blocks.CharBlock(
                                        help_text="Optional text to show in the step indicator.",
                                        icon="tag",
                                        required=False,
                                    ),
                                ),
                            ...
                            help_text="Scrollable steps to indicate progress in the storyline. Add a Step Anchor to create a new step.",
                            icon="list-ol",
                            use_json_field=True,
                        ),
                    ),
