    ...
    <div className="flex flex-row items-center justify-end gap-2">
      ...
      >
        ...
        <span className={` relative mx-1 ${disabled && "cursor-not-allowed"}`}>
          ...
          />
          <div
            className={`bg-yellow h-[30px] w-16 rounded-sm border-2 border-holon-blue-900 p-1 text-holon-blue-900 shadow-[4px_4px_0_0] ${
              disabled ? "after:bg-holon-grey-300" : "after:bg-holon-blue-500"
