    ...
    def test_rule_mapping_balancegroup_increase_upper(self):
        ...
        n_chc_assets = len(
            [
                ...
                if asset.__class__.__name__ == "ChemicalHeatConversionAsset"
            ]
        )
        n_ehc_assets = len(
            [
        ...
        n_thc_assets = len(
            [
                asset
                for asset in updated_scenario.assets
                if asset.__class__.__name__ == "TransportHeatConversionAsset"
            ]
        )
    ...
    def test_rule_mapping_balancegroup_new_asset(self):
        ...
        n_vc_assets = len(
            [
                asset
                for asset in updated_scenario.assets
                if asset.__class__.__name__ == "VehicleConversionAsset"
            ]
        )
        n_thc_assets = len(
            [
