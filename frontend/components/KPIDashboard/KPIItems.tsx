...
export default function KPIItems({ view, previousData, data, level, loading }: KPIItems) {
  return (
    <React.Fragment>
      {data[level] ? (
        <React.Fragment>
            <GridLoadKpi view={view} currentValue={data[level].netload} previousValue={previousData[level].netload} />
            <CostKpi view={view} currentValue={data[level].costs} previousValue={previousData[level].costs} />
            <SustainabilityKpi view={view} currentValue={data[level].sustainability} previousValue={previousData[level].sustainability} />
            <SelfSufficiencyKpi view={view} currentValue={data[level].selfSufficiency} previousValue={previousData[level].selfSufficiency} />
        </React.Fragment>
      ) : (
